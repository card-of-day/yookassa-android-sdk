...
* [Модерация приложения (использование QUERY_ALL_PACKAGES)](#вопрос-модерации)
...
# <a name="подключение-через-gradle"></a> Подключение через Gradle
...
# <a name="вопрос-модерации"></a> Использование разрешения QUERY_ALL_PACKAGES для доступа к пакетам (приложениям)
